...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BBWebHook', 'model/Curriculum', 'model/CurriculumUserProgress', 'model/CurriculumWithProgress', 'model/HostedDoc', 'model/InlineResponse200', 'model/InlineResponse200Items', 'model/JerichoConfiguration', 'model/JerichoPerformance', 'model/ModelString', 'model/OAuthClient', 'model/PromptBot', 'model/PromptSocialPrompt', 'model/SignUploadRequest', 'model/SignUploadResponse', 'model/TeamPublicRepresentation', 'model/VideoEmailPrompt', 'model/VideoEncodingStatusResponse', 'model/VideoPublicRepresentation', 'model/VideoRecorderMethodResponse', 'api/AccountsApi', 'api/AutomationsApi', 'api/ContactsApi', 'api/CurriculumApi', 'api/EmailsApi', 'api/FilesApi', 'api/FormsApi', 'api/IntegrationsApi', 'api/ListsApi', 'api/OrdersApi', 'api/PromptsApi', 'api/SocialsApi', 'api/TeamsApi', 'api/UtilitiesApi', 'api/VideosApi', 'api/WebhooksApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/BBWebHook'), require('./model/Curriculum'), require('./model/CurriculumUserProgress'), require('./model/CurriculumWithProgress'), require('./model/HostedDoc'), require('./model/InlineResponse200'), require('./model/InlineResponse200Items'), require('./model/JerichoConfiguration'), require('./model/JerichoPerformance'), require('./model/ModelString'), require('./model/OAuthClient'), require('./model/PromptBot'), require('./model/PromptSocialPrompt'), require('./model/SignUploadRequest'), require('./model/SignUploadResponse'), require('./model/TeamPublicRepresentation'), require('./model/VideoEmailPrompt'), require('./model/VideoEncodingStatusResponse'), require('./model/VideoPublicRepresentation'), require('./model/VideoRecorderMethodResponse'), require('./api/AccountsApi'), require('./api/AutomationsApi'), require('./api/ContactsApi'), require('./api/CurriculumApi'), require('./api/EmailsApi'), require('./api/FilesApi'), require('./api/FormsApi'), require('./api/IntegrationsApi'), require('./api/ListsApi'), require('./api/OrdersApi'), require('./api/PromptsApi'), require('./api/SocialsApi'), require('./api/TeamsApi'), require('./api/UtilitiesApi'), require('./api/VideosApi'), require('./api/WebhooksApi'));
  }
}(function(ApiClient, BBWebHook, Curriculum, CurriculumUserProgress, CurriculumWithProgress, HostedDoc, InlineResponse200, InlineResponse200Items, JerichoConfiguration, JerichoPerformance, ModelString, OAuthClient, PromptBot, PromptSocialPrompt, SignUploadRequest, SignUploadResponse, TeamPublicRepresentation, VideoEmailPrompt, VideoEncodingStatusResponse, VideoPublicRepresentation, VideoRecorderMethodResponse, AccountsApi, AutomationsApi, ContactsApi, CurriculumApi, EmailsApi, FilesApi, FormsApi, IntegrationsApi, ListsApi, OrdersApi, PromptsApi, SocialsApi, TeamsApi, UtilitiesApi, VideosApi, WebhooksApi) {
  'use strict';
