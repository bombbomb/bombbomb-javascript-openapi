...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bombbomb.AccountsApi();
  });
  ...
  describe('AccountsApi', function() {
    describe('accountDetails', function() {
      it('should call accountDetails successfully', function(done) {
        ...
        //instance.accountDetails(pet, function(error) {
    ...
    describe('subscriptionPurchaseAllowed', function() {
      it('should call subscriptionPurchaseAllowed successfully', function(done) {
        //uncomment below and update the code to test subscriptionPurchaseAllowed
        //instance.subscriptionPurchaseAllowed(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
