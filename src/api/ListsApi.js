  ...
  var exports = function(apiClient) {
    ...
    this.addNewList = function(listName, callback) {
      ...
      if (listName === undefined || listName === null) {
        throw new Error("Missing the required parameter 'listName' when calling addNewList");
      }
    ...
    this.clearList = function(listId, callback) {
      ...
      if (listId === undefined || listId === null) {
        throw new Error("Missing the required parameter 'listId' when calling clearList");
      }
    ...
    this.copyListContacts = function(fromListId, listId, callback) {
      ...
      if (fromListId === undefined || fromListId === null) {
        throw new Error("Missing the required parameter 'fromListId' when calling copyListContacts");
      }

      // verify the required parameter 'listId' is set
      if (listId === undefined || listId === null) {
        throw new Error("Missing the required parameter 'listId' when calling copyListContacts");
      }
    ...
    this.suppressAllInList = function(listId, callback) {
      ...
      // verify the required parameter 'listId' is set
      if (listId === undefined || listId === null) {
        throw new Error("Missing the required parameter 'listId' when calling suppressAllInList");
      }
