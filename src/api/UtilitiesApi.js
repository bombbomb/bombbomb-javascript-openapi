...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Bombbomb.UtilitiesApi = factory(root.Bombbomb.ApiClient, root.Bombbomb.OAuthClient);
  }
  ...
  var exports = function(apiClient) {
    ...
    this.createOAuthClient = function(name, redirectUri, callback) {
      ...
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling createOAuthClient");
      }

      // verify the required parameter 'redirectUri' is set
      if (redirectUri === undefined || redirectUri === null) {
        throw new Error("Missing the required parameter 'redirectUri' when calling createOAuthClient");
      }
