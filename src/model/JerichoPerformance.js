  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('jerichoId')) {
        obj['jerichoId'] = ApiClient.convertToType(data['jerichoId'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('promptsSent')) {
        obj['promptsSent'] = ApiClient.convertToType(data['promptsSent'], 'Integer');
      }
      if (data.hasOwnProperty('promptsWithRecordings')) {
        obj['promptsWithRecordings'] = ApiClient.convertToType(data['promptsWithRecordings'], 'Integer');
      }
      if (data.hasOwnProperty('promptsOptedOut')) {
        obj['promptsOptedOut'] = ApiClient.convertToType(data['promptsOptedOut'], 'Integer');
      }
    }
    return obj;
  }
