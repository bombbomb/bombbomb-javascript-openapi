  ...
  var exports = function(apiClient) {
    ...
    this.addContactsCSV = function(mappingData, listData, callback) {
      ...
      if (mappingData === undefined || mappingData === null) {
        throw new Error("Missing the required parameter 'mappingData' when calling addContactsCSV");
      }

      // verify the required parameter 'listData' is set
      if (listData === undefined || listData === null) {
        throw new Error("Missing the required parameter 'listData' when calling addContactsCSV");
      }
    ...
    this.addNewContact = function(contactEmail, opts, callback) {
      ...
      if (contactEmail === undefined || contactEmail === null) {
        throw new Error("Missing the required parameter 'contactEmail' when calling addNewContact");
      }
    ...
    this.addNewCustomField = function(fieldName, opts, callback) {
      ...
      if (fieldName === undefined || fieldName === null) {
        throw new Error("Missing the required parameter 'fieldName' when calling addNewCustomField");
      }
    ...
    this.addPastedContacts = function(contactEmails, opts, callback) {
      ...
      if (contactEmails === undefined || contactEmails === null) {
        throw new Error("Missing the required parameter 'contactEmails' when calling addPastedContacts");
      }
    ...
    this.cSVToObject = function(file, callback) {
      ...
      if (file === undefined || file === null) {
        throw new Error("Missing the required parameter 'file' when calling cSVToObject");
      }
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.listId The list of contacts to be deleted.
     * @param {String} opts.contactIds comma separated list of contact ids to delete
     ...
     */
    this.deleteContacts = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
