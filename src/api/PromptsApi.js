...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.createPromptBot = function(listId, emailId, name, subject, content, contactFieldValueColumn, botTypeId, templateId, opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     * data is of type: {@link module:model/PromptBot}
     */
    this.updatePromptBot = function(id, listId, emailId, name, subject, content, contactFieldValueColumn, templateId, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      // verify the required parameter 'listId' is set
      if (listId == undefined || listId == null) {
        throw "Missing the required parameter 'listId' when calling updatePromptBot";
      }
     ...
     * @param {String} opts.autoShares These are what we are autosharing to
