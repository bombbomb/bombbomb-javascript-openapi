  ...
  var exports = function(apiClient) {
    ...
    this.getAlternateCampaignContent = function(clientGroupId, callback) {
      ...
      if (clientGroupId == undefined || clientGroupId == null) {
        throw "Missing the required parameter 'clientGroupId' when calling getAlternateCampaignContent";
      }
    ...
    this.updatePromptTemplate = function(id, alternateContentId, newEmailId, ogEmailId, newExampleVideoId, callback) {
      ...
      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw "Missing the required parameter 'id' when calling updatePromptTemplate";
      }

      // verify the required parameter 'alternateContentId' is set
      if (alternateContentId == undefined || alternateContentId == null) {
        throw "Missing the required parameter 'alternateContentId' when calling updatePromptTemplate";
      }

      // verify the required parameter 'newEmailId' is set
      if (newEmailId == undefined || newEmailId == null) {
        throw "Missing the required parameter 'newEmailId' when calling updatePromptTemplate";
      }

      // verify the required parameter 'ogEmailId' is set
      if (ogEmailId == undefined || ogEmailId == null) {
        throw "Missing the required parameter 'ogEmailId' when calling updatePromptTemplate";
      }

      // verify the required parameter 'newExampleVideoId' is set
      if (newExampleVideoId == undefined || newExampleVideoId == null) {
        throw "Missing the required parameter 'newExampleVideoId' when calling updatePromptTemplate";
      }
