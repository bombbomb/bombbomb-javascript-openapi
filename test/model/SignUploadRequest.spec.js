...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bombbomb.SignUploadRequest();
  });
  ...
  describe('SignUploadRequest', function() {
    it('should create an instance of SignUploadRequest', function() {
      // uncomment below and update the code to test SignUploadRequest
      //var instane = new Bombbomb.SignUploadRequest();
      //expect(instance).to.be.a(Bombbomb.SignUploadRequest);
    });
