...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SignUploadRequest', 'model/VideoEncodingStatusResponse', 'model/VideoPublicRepresentation', 'model/VideoRecorderMethodResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/SignUploadRequest'), require('../model/VideoEncodingStatusResponse'), require('../model/VideoPublicRepresentation'), require('../model/VideoRecorderMethodResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Bombbomb) {
      root.Bombbomb = {};
    }
    root.Bombbomb.VideosApi = factory(root.Bombbomb.ApiClient, root.Bombbomb.SignUploadRequest, root.Bombbomb.VideoEncodingStatusResponse, root.Bombbomb.VideoPublicRepresentation, root.Bombbomb.VideoRecorderMethodResponse);
  }
}(this, function(ApiClient, SignUploadRequest, VideoEncodingStatusResponse, VideoPublicRepresentation, VideoRecorderMethodResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.getVideoEncodingStatus = function(videoId, callback) {
      ...
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling getVideoEncodingStatus");
      }
     ...
     * @param {Number} opts.width The width of the recorder to present.
    ...
    this.markLiveRecordingComplete = function(videoId, filename, title, callback) {
      ...
      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling markLiveRecordingComplete");
      }

      // verify the required parameter 'filename' is set
      if (filename === undefined || filename === null) {
        throw new Error("Missing the required parameter 'filename' when calling markLiveRecordingComplete");
      }

      // verify the required parameter 'title' is set
      if (title === undefined || title === null) {
        throw new Error("Missing the required parameter 'title' when calling markLiveRecordingComplete");
      }
    ...
    this.signUpload = function(policy, opts, callback) {
      ...
      if (policy === undefined || policy === null) {
        throw new Error("Missing the required parameter 'policy' when calling signUpload");
      }
    ...
    this.updateVideoThumbnailV2 = function(videoId, thumbnail, opts, callback) {
      ...
      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling updateVideoThumbnailV2");
      }

      // verify the required parameter 'thumbnail' is set
      if (thumbnail === undefined || thumbnail === null) {
        throw new Error("Missing the required parameter 'thumbnail' when calling updateVideoThumbnailV2");
      }
