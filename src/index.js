...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BBWebHook', 'model/Curriculum', 'model/CurriculumUserProgress', 'model/CurriculumWithProgress', 'model/InlineResponse200', 'model/InlineResponse200Items', 'model/JerichoConfiguration', 'model/JerichoPerformance', 'model/ModelString', 'model/OAuthClient', 'model/TeamPublicRepresentation', 'model/VideoEmailPrompt', 'api/CurriculumApi', 'api/PromptsApi', 'api/TeamsApi', 'api/UtilitiesApi', 'api/WebhooksApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/BBWebHook'), require('./model/Curriculum'), require('./model/CurriculumUserProgress'), require('./model/CurriculumWithProgress'), require('./model/InlineResponse200'), require('./model/InlineResponse200Items'), require('./model/JerichoConfiguration'), require('./model/JerichoPerformance'), require('./model/ModelString'), require('./model/OAuthClient'), require('./model/TeamPublicRepresentation'), require('./model/VideoEmailPrompt'), require('./api/CurriculumApi'), require('./api/PromptsApi'), require('./api/TeamsApi'), require('./api/UtilitiesApi'), require('./api/WebhooksApi'));
  }
}(function(ApiClient, BBWebHook, Curriculum, CurriculumUserProgress, CurriculumWithProgress, InlineResponse200, InlineResponse200Items, JerichoConfiguration, JerichoPerformance, ModelString, OAuthClient, TeamPublicRepresentation, VideoEmailPrompt, CurriculumApi, PromptsApi, TeamsApi, UtilitiesApi, WebhooksApi) {
  'use strict';
