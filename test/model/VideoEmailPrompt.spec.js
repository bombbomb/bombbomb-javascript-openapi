...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BombbombNodejsOpenapi.VideoEmailPrompt();
  });
  ...
  describe('VideoEmailPrompt', function() {
    it('should create an instance of VideoEmailPrompt', function() {
      ...
      //var instane = new BombbombNodejsOpenapi.VideoEmailPrompt();
      //expect(instance).to.be.a(BombbombNodejsOpenapi.VideoEmailPrompt);
    });
