...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/VideoRecorderMethodResponse', 'model/VideoPublicRepresentation', 'model/SignUploadRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/VideoRecorderMethodResponse'), require('../model/VideoPublicRepresentation'), require('../model/SignUploadRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.Bombbomb) {
      root.Bombbomb = {};
    }
    root.Bombbomb.VideosApi = factory(root.Bombbomb.ApiClient, root.Bombbomb.VideoRecorderMethodResponse, root.Bombbomb.VideoPublicRepresentation, root.Bombbomb.SignUploadRequest);
  }
}(this, function(ApiClient, VideoRecorderMethodResponse, VideoPublicRepresentation, SignUploadRequest) {
  'use strict';
