...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bombbomb.SignUploadResponse();
  });
  ...
  describe('SignUploadResponse', function() {
    it('should create an instance of SignUploadResponse', function() {
      // uncomment below and update the code to test SignUploadResponse
      //var instane = new Bombbomb.SignUploadResponse();
      //expect(instance).to.be.a(Bombbomb.SignUploadResponse);
    });
