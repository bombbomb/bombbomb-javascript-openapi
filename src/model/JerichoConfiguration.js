...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Bombbomb.JerichoConfiguration = factory(root.Bombbomb.ApiClient);
  }
   ...
   * @class
   * @param isPrompt {Boolean} Video Prompt: Determines whether this is a static or prompted send.
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('printToTemplate')) {
        obj['printToTemplate'] = ApiClient.convertToType(data['printToTemplate'], 'Boolean');
      }
      ...
      if (data.hasOwnProperty('customInitialEmailSubjectLine')) {
        obj['customInitialEmailSubjectLine'] = ApiClient.convertToType(data['customInitialEmailSubjectLine'], 'String');
      }
    }
    return obj;
  }
   ...
   * @member {Boolean} printToTemplate
   */
  exports.prototype['printToTemplate'] = undefined;
  /**
   ...
   * @member {String} customInitialEmailSubjectLine
   */
  exports.prototype['customInitialEmailSubjectLine'] = undefined;
