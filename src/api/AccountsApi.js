  ...
  var exports = function(apiClient) {
    ...
    this.createAccount = function(teamId, firstName, lastName, emailAddress, companyName, phone, opts, callback) {
      ...
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling createAccount");
      }

      // verify the required parameter 'firstName' is set
      if (firstName === undefined || firstName === null) {
        throw new Error("Missing the required parameter 'firstName' when calling createAccount");
      }

      // verify the required parameter 'lastName' is set
      if (lastName === undefined || lastName === null) {
        throw new Error("Missing the required parameter 'lastName' when calling createAccount");
      }

      // verify the required parameter 'emailAddress' is set
      if (emailAddress === undefined || emailAddress === null) {
        throw new Error("Missing the required parameter 'emailAddress' when calling createAccount");
      }

      // verify the required parameter 'companyName' is set
      if (companyName === undefined || companyName === null) {
        throw new Error("Missing the required parameter 'companyName' when calling createAccount");
      }

      // verify the required parameter 'phone' is set
      if (phone === undefined || phone === null) {
        throw new Error("Missing the required parameter 'phone' when calling createAccount");
      }
