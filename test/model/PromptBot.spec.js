...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bombbomb.PromptBot();
  });
  ...
  describe('PromptBot', function() {
    it('should create an instance of PromptBot', function() {
      // uncomment below and update the code to test PromptBot
      //var instane = new Bombbomb.PromptBot();
      //expect(instance).to.be.a(Bombbomb.PromptBot);
    });
    ...
    it('should have the property contactFieldValueColumn (base name: "contactFieldValueColumn")', function() {
      // uncomment below and update the code to test the property contactFieldValueColumn
      //var instane = new Bombbomb.PromptBot();
      //expect(instance).to.be();
    });
