...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bombbomb.CurriculumWithProgress();
  });
  ...
  describe('CurriculumWithProgress', function() {
    it('should create an instance of CurriculumWithProgress', function() {
      // uncomment below and update the code to test CurriculumWithProgress
      //var instane = new Bombbomb.CurriculumWithProgress();
      //expect(instance).to.be.a(Bombbomb.CurriculumWithProgress);
    });
