  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('sendMechanism')) {
        obj['sendMechanism'] = ApiClient.convertToType(data['sendMechanism'], 'String');
      }
      if (data.hasOwnProperty('hasSocial')) {
        obj['hasSocial'] = ApiClient.convertToType(data['hasSocial'], 'Boolean');
      }
