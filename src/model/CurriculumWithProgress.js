...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Bombbomb.CurriculumWithProgress = factory(root.Bombbomb.ApiClient, root.Bombbomb.CurriculumUserProgress);
  }
  ...
  /**
   * The CurriculumWithProgress model module.
   * @module model/CurriculumWithProgress
   * @version 2.0.22196
   */

  /**
   * Constructs a new <code>CurriculumWithProgress</code>.
   * The CurriculumWithProgress class
   * @alias module:model/CurriculumWithProgress
   * @class
   */
  ...
  /**
   * Constructs a <code>CurriculumWithProgress</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CurriculumWithProgress} obj Optional instance to populate.
   * @return {module:model/CurriculumWithProgress} The populated <code>CurriculumWithProgress</code> instance.
   */
