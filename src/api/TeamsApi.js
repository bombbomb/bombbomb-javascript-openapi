...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse200', 'model/JerichoConfiguration', 'model/JerichoPerformance', 'model/TeamPublicRepresentation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse200'), require('../model/JerichoConfiguration'), require('../model/JerichoPerformance'), require('../model/TeamPublicRepresentation'));
  } else {
    // Browser globals (root is window)
    if (!root.Bombbomb) {
      root.Bombbomb = {};
    }
    root.Bombbomb.TeamsApi = factory(root.Bombbomb.ApiClient, root.Bombbomb.InlineResponse200, root.Bombbomb.JerichoConfiguration, root.Bombbomb.JerichoPerformance, root.Bombbomb.TeamPublicRepresentation);
  }
}(this, function(ApiClient, InlineResponse200, JerichoConfiguration, JerichoPerformance, TeamPublicRepresentation) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.subgroupIds Subgroup IDs to add user to
    ...
    /**
     * Callback function to receive the result of the addUsers operation.
     * @callback module:api/TeamsApi~addUsersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} teamId The team id
     * @param {String} userDetails Array of emails or objects containing details needed to create user
     * @param {Object} opts Optional parameters
     * @param {String} opts.sendWelcomeEmail Whether to send welcome email to new users
     * @param {String} opts.subgroupIds Subgroup IDs to add user to
     * @param {module:api/TeamsApi~addUsersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addUsers = function(teamId, userDetails, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling addUsers");
      }

      // verify the required parameter 'userDetails' is set
      if (userDetails === undefined || userDetails === null) {
        throw new Error("Missing the required parameter 'userDetails' when calling addUsers");
      }
    ...
    /**
     * Callback function to receive the result of the addUsersFromCsv operation.
     * @callback module:api/TeamsApi~addUsersFromCsvCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} teamId The team id
     * @param {String} csvImportId ID of the CSV to import
     * @param {String} map Object to use when mapping import to AccountCreateDetails. Key is property name on details, value is CSV column number.
     * @param {Object} opts Optional parameters
     * @param {String} opts.sendWelcomeEmail Whether to send welcome email to new users
     * @param {String} opts.subgroupIds Subgroup IDs to add user to
     * @param {module:api/TeamsApi~addUsersFromCsvCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addUsersFromCsv = function(teamId, csvImportId, map, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling addUsersFromCsv");
      }

      // verify the required parameter 'csvImportId' is set
      if (csvImportId === undefined || csvImportId === null) {
        throw new Error("Missing the required parameter 'csvImportId' when calling addUsersFromCsv");
      }

      // verify the required parameter 'map' is set
      if (map === undefined || map === null) {
        throw new Error("Missing the required parameter 'map' when calling addUsersFromCsv");
      }
    ...
    this.cancelJerichoSend = function(jerichoId, callback) {
      ...
      if (jerichoId === undefined || jerichoId === null) {
        throw new Error("Missing the required parameter 'jerichoId' when calling cancelJerichoSend");
      }
    ...
    this.createSubteam = function(teamId, name, callback) {
      ...
      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling createSubteam");
      }

      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling createSubteam");
      }
    ...
    this.deleteSubteam = function(teamId, subteamId, callback) {
      ...
      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling deleteSubteam");
      }

      // verify the required parameter 'subteamId' is set
      if (subteamId === undefined || subteamId === null) {
        throw new Error("Missing the required parameter 'subteamId' when calling deleteSubteam");
      }
    ...
    this.getAllClientGroupAssociations = function(clientId, callback) {
      ...
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling getAllClientGroupAssociations");
      }
    ...
    this.getClientGroupAssets = function(assetType, opts, callback) {
      ...
      if (assetType === undefined || assetType === null) {
        throw new Error("Missing the required parameter 'assetType' when calling getClientGroupAssets");
      }
    ...
    /**
     * Callback function to receive the result of the getClientGroupStatistics operation.
     * @callback module:api/TeamsApi~getClientGroupStatisticsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} teamId The team id
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.memberStatus The status of members to query for
     * @param {module:api/TeamsApi~getClientGroupStatisticsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getClientGroupStatistics = function(teamId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling getClientGroupStatistics");
      }
    ...
    this.getJerichoSends = function(teamId, callback) {
      ...
      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling getJerichoSends");
      }
    ...
    this.getJerichoStats = function(jerichoId, teamId, callback) {
      ...
      // verify the required parameter 'jerichoId' is set
      if (jerichoId === undefined || jerichoId === null) {
        throw new Error("Missing the required parameter 'jerichoId' when calling getJerichoStats");
      }

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling getJerichoStats");
      }
    ...
    /**
     * Callback function to receive the result of the getPagedClientGroupMembers operation.
     * @callback module:api/TeamsApi~getPagedClientGroupMembersCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} teamId The team id
     * @param {String} pageSize Amount of records to return in a page.
     * @param {String} page The page to return.
     * @param {Object} opts Optional parameters
     * @param {String} opts.status The status type to filter by.
     * @param {String} opts.search Filter results with names that match the search term.
     * @param {module:model/String} opts.orderBy Key to order results by
     * @param {module:model/String} opts.orderDirection ASC or DESC
     * @param {module:api/TeamsApi~getPagedClientGroupMembersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getPagedClientGroupMembers = function(teamId, pageSize, page, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling getPagedClientGroupMembers");
      }

      // verify the required parameter 'pageSize' is set
      if (pageSize === undefined || pageSize === null) {
        throw new Error("Missing the required parameter 'pageSize' when calling getPagedClientGroupMembers");
      }

      // verify the required parameter 'page' is set
      if (page === undefined || page === null) {
        throw new Error("Missing the required parameter 'page' when calling getPagedClientGroupMembers");
      }
    ...
    /**
     * Callback function to receive the result of the getPromptMonthlyStats operation.
     * @callback module:api/TeamsApi~getPromptMonthlyStatsCallback
     * @param {String} error Error message, if any.
     * @param {'String'} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Jericho Monthly Stats
     * @param {String} month The month whose Jericho sends you wish to see.
     * @param {String} year The year whose Jericho sends you wish to see.
     * @param {module:api/TeamsApi~getPromptMonthlyStatsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link 'String'}
     */
    this.getPromptMonthlyStats = function(month, year, callback) {
      var postBody = null;

      // verify the required parameter 'month' is set
      if (month === undefined || month === null) {
        throw new Error("Missing the required parameter 'month' when calling getPromptMonthlyStats");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling getPromptMonthlyStats");
      }
    ...
    /**
     * Callback function to receive the result of the getPromptOverview operation.
     * @callback module:api/TeamsApi~getPromptOverviewCallback
     * @param {String} error Error message, if any.
     * @param {'String'} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Get Prompt Overview
     * Get Prompt Overview
     * @param {module:api/TeamsApi~getPromptOverviewCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link 'String'}
     */
    this.getPromptOverview = function(callback) {
      var postBody = null;
    ...
    this.getSubteams = function(teamId, callback) {
      ...
      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling getSubteams");
      }
    ...
    /**
     * Callback function to receive the result of the getTeamPromptAggregateStats operation.
     * @callback module:api/TeamsApi~getTeamPromptAggregateStatsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TeamsApi~getTeamPromptAggregateStatsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getTeamPromptAggregateStats = function(clientGroupId, callback) {
      var postBody = null;

      // verify the required parameter 'clientGroupId' is set
      if (clientGroupId === undefined || clientGroupId === null) {
        throw new Error("Missing the required parameter 'clientGroupId' when calling getTeamPromptAggregateStats");
      }
    ...
    /**
     * Callback function to receive the result of the getTeamPromptCampaigns operation.
     * @callback module:api/TeamsApi~getTeamPromptCampaignsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} clientGroupId ID of the client group association
     * @param {Object} opts Optional parameters
     * @param {String} opts.searchTerm The value to search for in prompt subject
     * @param {String} opts.currentPage The current page
     * @param {module:api/TeamsApi~getTeamPromptCampaignsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getTeamPromptCampaigns = function(clientGroupId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'clientGroupId' is set
      if (clientGroupId === undefined || clientGroupId === null) {
        throw new Error("Missing the required parameter 'clientGroupId' when calling getTeamPromptCampaigns");
      }
    ...
    /**
     * Callback function to receive the result of the inviteToSocialPromptTeam operation.
     * @callback module:api/TeamsApi~inviteToSocialPromptTeamCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} teamId The team id
     * @param {String} listId List to invite to the social prompt team.
     * @param {module:api/TeamsApi~inviteToSocialPromptTeamCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.inviteToSocialPromptTeam = function(teamId, listId, callback) {
      var postBody = null;

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling inviteToSocialPromptTeam");
      }

      // verify the required parameter 'listId' is set
      if (listId === undefined || listId === null) {
        throw new Error("Missing the required parameter 'listId' when calling inviteToSocialPromptTeam");
      }
    ...
    this.queueJerichoSend = function(config, teamId, callback) {
      ...
      if (config === undefined || config === null) {
        throw new Error("Missing the required parameter 'config' when calling queueJerichoSend");
      }

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling queueJerichoSend");
      }
    ...
    this.removeMemberFromTeam = function(teamId, userId, callback) {
      ...
      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling removeMemberFromTeam");
      }

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling removeMemberFromTeam");
      }
    ...
    /**
     * Callback function to receive the result of the resendTeamMemberInvitation operation.
     * @callback module:api/TeamsApi~resendTeamMemberInvitationCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TeamPublicRepresentation} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} teamId The team id
     * @param {String} memberUserId The user id of the member being resent an invitation.
     * @param {module:api/TeamsApi~resendTeamMemberInvitationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TeamPublicRepresentation}
     */
    this.resendTeamMemberInvitation = function(teamId, memberUserId, callback) {
      var postBody = null;

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling resendTeamMemberInvitation");
      }

      // verify the required parameter 'memberUserId' is set
      if (memberUserId === undefined || memberUserId === null) {
        throw new Error("Missing the required parameter 'memberUserId' when calling resendTeamMemberInvitation");
      }
    ...
    this.updateJerichoPromptSend = function(teamId, jerichoId, callback) {
      ...
      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling updateJerichoPromptSend");
      }

      // verify the required parameter 'jerichoId' is set
      if (jerichoId === undefined || jerichoId === null) {
        throw new Error("Missing the required parameter 'jerichoId' when calling updateJerichoPromptSend");
      }
     ...
     * @param {String} opts.state The status of the login permissions
     * @param {Boolean} opts.subteamsCanAddMembers Updates subteam member adding setting on group
    ...
    this.updateTeam = function(teamId, opts, callback) {
      ...
      var formParams = {
        'name': opts['name'],
        'state': opts['state'],
        'subteamsCanAddMembers': opts['subteamsCanAddMembers']
      };
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.permissionSuiteId Set if the user is an admin of this team.
     ...
     */
    this.updateTeamMember = function(teamId, userId, admin, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'teamId' is set
      if (teamId === undefined || teamId === null) {
        throw new Error("Missing the required parameter 'teamId' when calling updateTeamMember");
      }

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling updateTeamMember");
      }

      // verify the required parameter 'admin' is set
      if (admin === undefined || admin === null) {
        throw new Error("Missing the required parameter 'admin' when calling updateTeamMember");
      }
      ...
      var formParams = {
        'userId': userId,
        'admin': admin,
        'permissionSuiteId': opts['permissionSuiteId']
      };
