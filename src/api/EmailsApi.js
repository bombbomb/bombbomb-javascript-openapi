...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    this.getTemplateHtmlForTemplateId = function(templateId, opts, callback) {
      ...
      // verify the required parameter 'templateId' is set
      if (templateId == undefined || templateId == null) {
        throw "Missing the required parameter 'templateId' when calling getTemplateHtmlForTemplateId";
      }
     ...
     * @param {Integer} opts.scheduledSendTimestamp When to schedule the send (seconds since epoch). null value means send immediately.
